...
class Header extends Component {
  ...
  render() {
    ...
    const isUsersPage = pathname.indexOf("user") > -1;
    const isReposPage = pathname.indexOf("repo") > -1;
      ...
      <Link to="/" className="navbar-brand">
        ...
        <div id="navbarCollapse" className="collapse navbar-collapse">
          ...
          <ul className="navbar-nav mt-2 mt-md-0">
            <Alerts />
            <UserProfile user={user} handleLogout={this.onLogoutClick} handleSignup={this.onSignupClick}  />
          </ul>
        </div>
      </nav>
    );
